...
import type { SeoSettings } from '@/server/seo.schema';
import { getSeoSettings, updateSeoSettings } from '@/server/seo.server';
    ...
    <div className="space-y-4">
      ...
      {loading ? (
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-base">Social defaults</CardTitle>
            </CardHeader>
            <CardContent className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-1.5">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                />
                <p className="text-xs text-muted-foreground">
                  Served at <code>/api/seo/robots.txt</code>. Empty falls back
                  to a sitemap-aware default.
                </p>
              </div>
            </CardContent>
          </Card>
